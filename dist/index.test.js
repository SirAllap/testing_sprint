...
describe('Testing class Room', () => {
    test('isOccupied: returns true when the room is occupied on a given date', () => {
        ...
        const booking1 = new index_1.Booking('booking 1', 'booking1@bo.com', '2023-10-01', '2023-10-06', 10, room);
        const booking2 = new index_1.Booking('booking 2', 'booking1@bo.com', '2023-10-07', '2023-10-15', 10, room);
    ...
    test('isOccupied: returns false when the room is occupied on a given date ', () => {
        ...
        const booking1 = new index_1.Booking('booking 1', 'booking1@bo.com', '2023-10-01', '2023-10-06', 10, room);
        const booking2 = new index_1.Booking('booking 2', 'booking1@bo.com', '2023-10-07', '2023-10-31', 10, room);
        const bookings = [booking1, booking2];
        const room1 = new index_1.Room(room.name, bookings, room.rate, room.discount);
    ...
    test('isOccupied: returns `You introduce a invalid date` if the introduced data is not a valid date', () => {
        ...
        const booking2 = new index_1.Booking('booking 2', 'booking1@bo.com', '2023-10-07', '2023-10-15', 10, room);
        const bookings = [booking1, booking2];
        const room2 = new index_1.Room(room.name, bookings, room.rate, room.discount);
        expect(() => {
            room2.isOccupied('whatever is not a real date');
        }).toThrow('You introduce a invalid date');
    });
    test('occupancyPercentage: returns the percentage of days occupied based on the date range we provide', () => {
        ...
        const booking1 = new index_1.Booking('booking 1', 'booking1@bo.com', '2023-10-01', '2023-10-15', 10, room);
        const booking2 = new index_1.Booking('booking 2', 'booking1@bo.com', '2023-10-16', '2023-10-31', 10, room);
        const bookings = [booking1, booking2];
        const booking3 = new index_1.Booking('booking 3', 'booking1@bo.com', '2024-01-31', '2024-02-09', 10, room);
        const booking4 = new index_1.Booking('booking 4', 'booking1@bo.com', '2024-02-10', '2024-03-10', 10, room);
        const bookings1 = [booking3, booking4];
        const room3 = new index_1.Room(room.name, bookings, room.rate, room.discount);
        const roomEarlier = new index_1.Room(room.name, bookings1, room.rate, room.discount);
        const percentageNumber = room3.occupancyPercentage('2023-10-01', '2023-10-31');
        const percentageNumber2 = room3.occupancyPercentage('2023-10-01', '2023-11-15');
        const percentageNumber3 = room3.occupancyPercentage('2023-09-01', '2023-12-31');
        const percentageNumber4 = room3.occupancyPercentage('2023-11-26', '2023-09-01');
        const percentageNumber5 = roomEarlier.occupancyPercentage('2024-01-01', '2024-04-01');
    ...
    test('availableRooms:returns an array with all the rooms that are not occupied by the given date', () => {
        ...
        const booking3 = new index_1.Booking('booking 3', 'bok@bok.es', '2023-09-01', '2023-09-02', 10, roomB);
        const booking4 = new index_1.Booking('booking 4', 'bok2@bok.es', '2023-09-03', '2023-09-05', 10, roomB);
        const bookingsB = [booking3, booking4];
        const roomC = {
            name: 'Room: 4',
            rate: 150,
        ...
        const booking5 = new index_1.Booking('booking 5', 'bok@bok.es', '2023-12-01', '2023-12-14', 10, roomB);
        const booking6 = new index_1.Booking('booking 6', 'bok2@bok.es', '2023-12-15', '2023-12-31', 10, roomB);
        const bookingsC = [booking5, booking6];
        const room2 = new index_1.Room(roomA.name, bookingsA, roomA.rate, roomA.discount);
        const room3 = new index_1.Room(roomB.name, bookingsB, roomB.rate, roomB.discount);
        const room4 = new index_1.Room(roomC.name, bookingsC, roomC.rate, roomC.discount);
        const roomArray = [room2, room3, room4];
        const arrayEmptyRooms = index_1.Room.availableRooms(roomArray, '2023-10-01', '2023-10-15');
    ...
    test('availableRooms: returns `No available room within the given range` if the rooms are occupied during the provided date range.', () => {
        ...
        const booking1 = new index_1.Booking('booking 1', 'bok@bok.es', '2023-09-15', '2023-09-30', 10, roomA);
        const booking2 = new index_1.Booking('booking 2', 'bok2@bok.es', '2023-10-01', '2023-10-07', 10, roomA);
        const bookingsA = [booking1, booking2];
        const room1 = new index_1.Room(roomA.name, bookingsA, roomA.rate, roomA.discount);
...
describe('Testing class Booking', () => {
    test('getFee: returns the fee with 10% discount from the room', () => {
        ...
        const deluxeBooking = new index_1.Booking('David PR', 'david.pr.developer@gmail.com', '2023-10-10', '2023-10-11', 0, deluxeRoom);
    ...
    test('getFee: returns the fee with 10% discount from the booking', () => {
        ...
        const deluxeBooking = new index_1.Booking('David PR', 'david.pr.developer@gmail.com', '2023-10-10', '2023-10-11', 20, deluxeRoom);
    ...
    test('getFee: returns the fee with 10% discount from the room + 5% from the booking', () => {
        ...
        const deluxeBooking = new index_1.Booking('David PR', 'david.pr.developer@gmail.com', '2023-10-10', '2023-10-11', 5, deluxeRoom);
